    ...
    <div class="menu-preview">
        ...
        <el-scrollbar
            ...
            <div class="userinfo"
                ...
                <el-image v-if="avatar" :style="verticalStyle2[isCollapse?'close':'open'].userinfo.img.default"
            ...
            <el-menu :default-active="activeMenu" :unique-opened="true"
                ...
                <el-menu-item class="home" :popper-append-to-body="false" popper-class="home"
                              @click.native="menuHandler('')"
                              :style="verticalStyle2[isCollapse?'close':'open'].home.one.box.default" index="/">
                ...
                <el-submenu class="user" popper-class="user" :popper-append-to-body="false"
                    ...
                    <el-menu-item index="/updatePassword" @click="menuHandler('updatePassword')">Change password
                    </el-menu-item>
                ...
                <template v-for="(menu,index) in menuList.backMenu">
                    <el-submenu v-if="menu.child.length > 1 || !verticalIsMultiple" class="other" popper-class="other"
                                :popper-append-to-body="false"
                                :style="verticalStyle2[isCollapse?'close':'open'].menu.one.box.default"
                                :index="index+2+''">
                        <template slot="title">
                            <i :style="verticalStyle2[isCollapse?'close':'open'].menu.one.icon.default"
                               class="el-icon-menu" :class="icons[index]"></i>
                            <span :style="verticalStyle2[isCollapse?'close':'open'].menu.one.title.default"
                                  slot="title">{{ menu.menu + (verticalFlag ? '管理' : '') }}</span>
                        </template>
                        <el-menu-item v-for="(child,sort) in menu.child" :key="sort" :index="'/'+child.tableName"
                                      @click="menuHandler(child.tableName)">{{ child.menu }}
                        </el-menu-item>
                    </el-submenu>
                    <el-menu-item v-if="menu.child.length <= 1 && verticalIsMultiple" class="other" popper-class="other"
                                  :style="verticalStyle2[isCollapse?'close':'open'].menu.one.box.default"
                                  @click="menuHandler(menu.child[0].tableName)" :index="'/'+menu.child[0].tableName">
                        <div class="el-tooltip">
                            <i :style="verticalStyle2[isCollapse?'close':'open'].menu.one.icon.default"
                               class="el-icon-menu" :class="icons[index]"></i>
                            <span :style="verticalStyle2[isCollapse?'close':'open'].menu.one.title.default"
                                  slot="title">{{ menu.child[0].menu + (verticalFlag ? '管理' : '') }}</span>
                        </div>
                    </el-menu-item>
                </template>
            </el-menu>
...
export default {
            ...
            verticalStyle2: {
                "isCollapse": false, "close": {
                    ...
                    "menu": {
                        ...
                        "one": {
                            "box1": {
                                "hover": {"color": "#c1d2e2", "background": "#263445"},
                                "active": {"color": "#c1d2e2", "background": "#263445"},
                                "default": {
                                    "cursor": "pointer",
                                    "padding": "0 8px",
                                    "whiteSpace": "nowrap",
                            ...
                            "box": {
                                "hover": {},
                                "default": {"padding": "0", "listStyle": "none", "margin": "0", "fontSize": "inherit"}
                            },
                            "title": {
                                "hover": {},
                                "default": {
                    ...
                    "btn": {
                        "icon": {
                            "hover": {},
                            "default": {"color": "inherit", "margin": "0 6px 0", "fontSize": "24px"},
                            "text": "icon-shousuo17"
                        },
                        "hover": {"opacity": "0.8"},
                        "default": {
                    ...
                    "user": {
                        "two": {
                            "title": {
                                "hover": {
                                    "padding": "0 0px",
                                    "backgroundColor": "#263445!important",
                                    "lineHeight": "40px",
                                    "color": "#c1d2e2",
                                    "height": "40px"
                                },
                    ...
                    "home": {
                        ...
                        "one": {
                            "box1": {
                                "hover": {"color": "#fff", "background": "rgba(86,178,198,.8)"},
                                "active": {"color": "#fff", "background": "rgba(86,178,198,.8)"},
                                "default": {
                                    "cursor": "pointer",
                                    "padding": "0 8px",
                                    "whiteSpace": "nowrap",
                            ...
                            "box": {
                                "hover": {},
                                "default": {"padding": "0", "listStyle": "none", "margin": "0", "display": "block"}
                            },
                            "title": {
                                "hover": {},
                                "default": {
                    ...
                    "menu": {
                        ...
                        "one": {
                            "box1": {
                                "hover": {"color": "#bbccde", "background": "#263445", "height": "auto"},
                                "active": {"color": "#bbccde", "background": "none", "height": "auto"},
                                "default": {
                                    "cursor": "pointer",
                                    "border": "0px solid rgba(3, 152, 15, .2)",
                                    "padding": "20px 20px",
                    ...
                    "btn": {
                        "icon": {
                            "hover": {},
                            "default": {"color": "inherit", "margin": "0px 2px", "fontSize": "24px"},
                            "text": "icon-shousuo17"
                        },
                        "hover": {"opacity": "0.8"},
                        "default": {
                    ...
                    "userinfo": {
                        "nickname": {
                            "hover": {},
                            "default": {"fontSize": "22px", "lineHeight": "1.5", "color": "#333", "textAlign": "center"}
                        },
                        "img": {
                            "hover": {},
                            "default": {
                    ...
                    "home": {
                        "two": {
                            ...
                            "box1": {
                                "hover": {"color": "#bbccde", "background": "#263445"},
                                "active": {"color": "#bbccde", "background": "#263445"},
                                "default": {
                                    "cursor": "pointer",
                                    "border": "0px solid rgba(3, 152, 15, .2)",
                                    "padding": "20px 20px",
    ...
    mounted() {
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                if (sessionTable == 'juyuan') {
                    this.avatar = data.data.touxiang
                }
                if (sessionTable == 'daikuanzhuanyuan') {
                    this.avatar = data.data.touxiang
                }
