...
<div class="content" :style='{"padding":"0px 20px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230831/a5f221858a6744baab19924fb77cee81.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"100%"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"width":"100%","margin":"30px auto 40px","fontSize":"22px","color":"rgb(51, 51, 51)","textAlign":"center","fontWeight":"500"}'>Welcome to use {{this.$project.projectName}}</div>
	<!-- statis -->
	<div :style='{"border":"0px solid rgba(126, 96, 16, .1)","padding":"0px 0","margin":"0 30px 30px 0px","alignItems":"center","color":"#666","flexWrap":"wrap","background":"none","display":"flex","width":"250px","fontSize":"14px","justifyContent":"center","order":"0"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#e7e8f8","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('juyuan','home page总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{juyuanCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>Total number of tellers</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#e7f8f8","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('daikuanzhuanyuan','home page总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#ceeded","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{daikuanzhuanyuanCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>Total number of loan officers</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#e7f8e8","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('kehu','home page总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#ceedd0","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{kehuCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>Total number of customers</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#f8f8e6","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('yinxingzhanghu','home page总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#e8e8c8","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{yinxingzhanghuCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>Total number of bank accounts</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"8px 0","margin":"0 0 10px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"space-around","borderRadius":"0px","background":"#f8f3e8","borderWidth":"0px","width":"100%","borderStyle":"solid"}' v-if="isAuth('daikuanshenqing','home page总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fff","display":"flex","width":"48px","justifyContent":"center","height":"48px"}'>
				<span class="icon iconfont icon-tongji18" :style='{"color":"#e8dec6","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{daikuanshenqingCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>Total number of loan applications</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"420px","order":"10"}'>
		<div id="cunkuanjiluChart1" class="echarts1" v-if="isAuth('cunkuanjilu','home page统计')"></div>
		<div id="zhuanzhangjiluChart1" class="echarts2" v-if="isAuth('zhuanzhangjilu','home page统计')"></div>
<!--
		<div id="daikuanshenqingChart1" class="echarts3" v-if="isAuth('daikuanshenqing','home page统计')"></div>
-->
	</div>
</div>
</template>
...
export default {
	data() {
		return {
            juyuanCount: 0,
            daikuanzhuanyuanCount: 0,
            kehuCount: 0,
            yinxingzhanghuCount: 0,
            daikuanshenqingCount: 0,
	...
	mounted(){
		this.init();
		this.getjuyuanCount();
		this.getdaikuanzhuanyuanCount();
		this.getkehuCount();
		this.getyinxingzhanghuCount();
		this.cunkuanjiluChat1();
		this.zhuanzhangjiluChat1();
		//this.getdaikuanshenqingCount();
		this.daikuanshenqingChat1();
	},
	methods:{
		// 词云
		...
		getjuyuanCount() {
			this.$http({
				...
				if (data && data.code == 0) {
					this.juyuanCount = data.data
				}
			})
		},
		getdaikuanzhuanyuanCount() {
			this.$http({
				url: `daikuanzhuanyuan/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.daikuanzhuanyuanCount = data.data
				}
			})
		},
		getkehuCount() {
			this.$http({
				...
				if (data && data.code == 0) {
					this.kehuCount = data.data
				}
			})
		},
		getyinxingzhanghuCount() {
			this.$http({
				url: `yinxingzhanghu/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.yinxingzhanghuCount = data.data
				}
			})
		},
		cunkuanjiluChat1() {
        ...
        var cunkuanjiluChart1 = echarts.init(document.getElementById("cunkuanjiluChart1"),'macarons');
        this.$http({
            url: `cunkuanjilu/value/customer_name/amount`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].customer_name);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].customer_name
                    })
                }
                var option = {};
				let titleObj = this.bar.title
				titleObj.text = 'Customer Deposit Statistics'
                ...
                // 使用刚指定的配置项和数据显示图表。
                cunkuanjiluChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    cunkuanjiluChart1.resize();
                };
            }
        });
      })
        ...
        var zhuanzhangjiluChart1 = echarts.init(document.getElementById("zhuanzhangjiluChart1"),'macarons');
        this.$http({
            url: "zhuanzhangjilu/group/transfer_time",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].transfer_time);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].transfer_time
                    })
                }
                var option = {};
				let titleObj = this.line.title
				titleObj.text = 'Daily transfer volume of customers'
                ...
                // 使用刚指定的配置项和数据显示图表。
                zhuanzhangjiluChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    zhuanzhangjiluChart1.resize();
                };
            }
        });
      })
		...
		getdaikuanshenqingCount() {
			this.$http({
				url: `daikuanshenqing/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.daikuanshenqingCount = data.data
				}
			})
		},
		daikuanshenqingChat1() {
			this.$nextTick(()=>{

        var daikuanshenqingChart1 = echarts.init(document.getElementById("daikuanshenqingChart1"),'macarons');
        this.$http({
            url: "daikuanshenqing/group/customer_name",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                daikuanshenqingChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    daikuanshenqingChart1.resize();
                };
            }
        });
      })
