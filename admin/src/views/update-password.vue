<template>
  <div :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="Password" prop="password">
		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'juyuan') {
					}
					if (this.$storage.get("sessionTable") == 'daikuanzhuanyuan') {
					}
					this.user.password = this.ruleForm.newpassword;
					this.user.mima = this.ruleForm.newpassword;
					this.$http({
